...
int bfs(int u, int end)
{
    ...
    q.push(u);
    // set initial step to -1 to account for additional step from supernode
    steps.push(-1);
    v[u] = true;
...
/*
idea: perform BFS as usual, however add a supernode connecting to all nodes of elevation 'a'.
*/
int main()
{
    // parse grid
